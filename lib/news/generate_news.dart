...
class _GenerateNewsState extends State<GenerateNews> {
  ...
  void initState() {
    ...
    finalHour = fianlTime.hour > 12 && fianlTime.hour <= 24
        ? fianlTime.hour - 12
        : fianlTime.hour;
                              ...
                              TextButton(
                                  ...
                                  onPressed: () async {
                                    ...
                                    if (timeOfDay != null) {
                                      setState(() {
                                        fianlTime = timeOfDay;
                                        finalAmPm = fianlTime.hour >= 12 &&
                                                fianlTime.hour < 24
                                            ? "오후"
                                            : "오전";
                                        finalHour = fianlTime.hour > 12 &&
                                                fianlTime.hour <= 24
                                            ? fianlTime.hour - 12
                                            : initialTime.hour;
                                        if (finalHour == 0) finalHour = 12;
                                  ...
                                  child: Text(
                                      '${finalAmPm} ${finalHour}:${fianlTime.minute}')),
                            ],
                          ),
                        ),
                      ],
