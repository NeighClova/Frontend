...
class NoAuthChangePasswordPage extends StatefulWidget {
  final String email;
  const NoAuthChangePasswordPage({Key? key, required this.email}) : super(key: key);

  @override
  State<NoAuthChangePasswordPage> createState() => _NoAuthChangePasswordPageState(email: email);
}

class _NoAuthChangePasswordPageState extends State<NoAuthChangePasswordPage> {
  final String email;
  _NoAuthChangePasswordPageState({required this.email});
